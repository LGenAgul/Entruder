...
def enum_consents(
    ...
    client:    str = typer.Option(None, "-l", "--client", help="Filter by client app name e.g. 'My Risky App' (Optional)"),
    admin_consented: bool = typer.Option(False, "-a", "--admin-consented", help="Only show org-wide grants (consentType 'AllPrincipals') (Optional)"),
